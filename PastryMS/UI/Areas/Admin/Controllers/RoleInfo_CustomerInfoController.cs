...
namespace UI.Areas.Admin.Controllers
{
    ...
    public class RoleInfo_CustomerInfoController : Controller
    {
        ...
        public RoleInfo_CustomerInfoController(
		...
		[HttpGet]
		public IActionResult GetBindStaffIdOptions(string roleId)
		{
			ReturnResult result = new ReturnResult();
			if (string.IsNullOrWhiteSpace(roleId))
			{
			...
			List<GetStaffInfoDTO> options = _staffInfoBLL.GetStaffInfoDTO();
